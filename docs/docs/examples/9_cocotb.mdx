...
:::
:::warning
Verilator is the less supported tool by cocotb, we recommend using [Icarus Verilog](https://github.com/steveicarus/iverilog).
:::
...
Python requirement file, used to install the recommended cocotb version in a virtual environment
...
To run the simulation, we first need to create a python environment, then activate it to install the recommended cocotb version:

```bash
python3 -m venv .venv                  # Create python virtual environment
source .venv/bin/activate              # Activate python virtual environment
pip install -r python_requirements.txt # Install recommended cocotb version
```
