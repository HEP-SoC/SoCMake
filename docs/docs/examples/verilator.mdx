...
const adder_v = require('!!raw-loader!../../../examples/verilator/adder/adder.v')?.default;
const cmakelists = require('!!raw-loader!../../../examples/verilator/CMakeLists.txt')?.default;
const adder_cmakelists = require('!!raw-loader!../../../examples/verilator/adder/CMakeLists.txt')?.default;
const main_cpp = require('!!raw-loader!../../../examples/verilator/main.cpp')?.default;
