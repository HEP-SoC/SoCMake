...
SoCMake allow to use options, a script can easily be adapted to fit in a different environment or to test different tools or features depending on your needs.
