...
There is plenty of bad examples online of CMake code, typically comming from the old versions that one should avoid.

Modern CMake is all about creating targets instead of global variables, and this fits really well in the Hardware hierarchy as it will be explained later.
...
const graph = require('!!raw-loader!../../static/examples/linking_ips/graph.dot')?.default;
