...
function(${${TEST_NAME}})
    add_ip(gip_parent1 VENDOR test LIBRARY getip VERSION 1.0.0)
    set(PARENT ${IP})
    add_ip(gip_child1 VENDOR test LIBRARY getip VERSION 1.0.0)
...
ct_add_test(NAME ${TEST_NAME})
function(${${TEST_NAME}})
    add_ip(gip_parent2 VENDOR test LIBRARY getip VERSION 1.0.0)
    set(PARENT ${IP})
    add_ip(gip_child2 VENDOR test LIBRARY getip VERSION 1.0.0)
...
ct_add_test(NAME ${TEST_NAME})
function(${${TEST_NAME}})
    add_ip(gip_top3 VENDOR test LIBRARY getip VERSION 1.0.0)
    set(TOP ${IP})
    add_ip(gip_sub3 VENDOR test LIBRARY getip VERSION 1.0.0)
