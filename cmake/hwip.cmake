...
#[[[
# Parse a VLNV-formatted IP name string (e.g. ``vendor::lib::ip::0.0.1``) into its components.
#
...
#
# :param IP_VLNV: The VLNV-formatted string to parse (e.g. ``vendor::lib::ip::0.0.1``).
# :type IP_VLNV: string
#
# **Keyword Arguments**
#
# :keyword VENDOR: Name of the variable in the calling scope that receives the vendor token. Defaults to ``VENDOR``.
# :type VENDOR: string
# :keyword LIBRARY: Name of the variable in the calling scope that receives the library token. Defaults to ``LIBRARY``.
# :type LIBRARY: string
# :keyword IP_NAME: Name of the variable in the calling scope that receives the IP name token. Defaults to ``IP_NAME``.
# :type IP_NAME: string
# :keyword VERSION: Name of the variable in the calling scope that receives the version token. Defaults to ``VERSION``.
# :type VERSION: string
#]]
#[[[ @module hwip
#]]
